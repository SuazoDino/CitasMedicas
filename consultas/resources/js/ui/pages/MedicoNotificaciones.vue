    ...
    <div class="container">
      <header class="page-header">
        <div>
          ...
          <p>Gestiona cómo y cuándo recibes notificaciones sobre tus citas y pacientes.</p>
        </div>
      ...
      <div v-else class="config-content">
        ...
        <div class="config-section">
          ...
          <div class="section-details">
            <p class="detail-text">
              Recibirás emails con recordatorios de citas próximas, confirmaciones de pacientes y cambios en tu agenda.
            </p>
        ...
        <div class="config-section">
          ...
          <div class="section-details">
            <p class="detail-text">
              Recibirás mensajes de texto con recordatorios importantes sobre tus citas y pacientes.
            </p>
...
async function cargarPreferencias() {
  ...
  try {
    const [prefsRes, userRes] = await Promise.all([
      api.get('/medico/notificaciones/preferencias'),
      api.get('/auth/me'),
    ])
...
async function guardarPreferencias() {
  ...
  try {
    await api.put('/medico/notificaciones/preferencias', preferencias.value)
